<head>
  ...
  <link rel="stylesheet" href="{{asset('landingPage/css/font-awesome.min.css')}}" type="text/css">
  <link rel="stylesheet" href="{{asset('landingPage/css/elegant-icons.css')}}" type="text/css">
  <link rel="stylesheet" href="{{asset('landingPage/css/nice-select.css')}}" type="text/css">
