                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="shoping__cart__quantity">
                                        <div class="quantity">
                                            <div class="">
                                                <input type="number" name="jumlah"  onchange="hasil('{{$loop->iteration}}')" id="jumlah_{{$loop->iteration}}">
                                            </div>
                                        </div>
                                    </td>
                                    <td class="shoping__cart__total">
                                        <span id="total_{{$loop->iteration}}">0</span>
                                        {{-- {{$item->produk->harga}} --}}
                                    </td>
                ...
                <div class="col-lg-6 text-end">
                    <div class="shoping__checkout">
                        ...
                        <ul>
                            ...
                            <li>Total <span id="">$454.98</span></li>
                        </ul>
